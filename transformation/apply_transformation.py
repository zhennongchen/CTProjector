...
def apply_affine_transform(image, transform_matrix, channel_wise = False, channel_index = 0, fill_mode="constant", cval=0., order=0):
    ...
    if channel_wise == False:
        ...
        return affine_transform(image, final_affine_matrix, final_offset, order=0, mode=fill_mode, cval=cval)
